...
⚠️ ПРАВИЛО КЛАССИФИКАЦИИ:
· Если пилот сейчас в контроле (control) но пользователь добавляет done/plan/risks → ИСПОЛЬЗУЙ active, не control!
· Пилот переходит в active когда есть недельная работа (done/plan/risks)
· Пилот остается в control только если НЕТУ done/plan/risks (только artifact или owner)
