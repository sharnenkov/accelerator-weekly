...
3. ВАЖНО: Если пользователь переотправляет данные (повторение):
   · Всё равно создай PATCH и отправь его — пользователь может переправлять или уточнять
   · Не игнорируй данные, даже если они похожи на старые
