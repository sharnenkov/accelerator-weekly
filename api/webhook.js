...
· ⚠️ ВАЖНО: Начинай новую запись с ТЕКУЩЕЙ ДАТЫ (не 07.07, а реальная дата дня):
...
· ВНД обновление (добавить/обновить): { "vnd": { "items": [{ "name": "ВНД: Получение и актуализация ОС от департаментов", "done": "07.07 — Получена ОС от ДАР", "artifact": "Письмо от ДАР" }] } }
