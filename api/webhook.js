...
🔍 <b>Поиск</b> — сколько новых инноваций найдено + карточка по каждой:
  ...
  · ⚠️ <b>ВАЖНО:</b> Когда пользователь говорит "X решений в базе" → ОБЯЗАТЕЛЬНО обнови ОБА поля одновременно:
    { "search": { "innovations_base": X, "innovations_total": X } }
    Это НЕ два отдельных PATCH'а, а ОДИН с обоими полями!
...
3. КОГДА ВСЕ ДАННЫЕ СОБРАНЫ — ВСЕГДА СОЗДАВАЙ И ОТПРАВЛЯЙ PATCH:
...
4. Верни патч в строгом формате:
